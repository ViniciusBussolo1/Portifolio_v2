...
export function Contact() {
  return (
    <section
      id="contato"
      className="w-full h-[45.688rem] bg-black-80 flex justify-center items-center px-4 min-[515px]:px-2 pt-[9.375rem]"
    >
      <div className="max-w-[39.375rem] w-full flex flex-col justify-center items-center gap-[5.625rem]">
        <TitleSection title="Contato" />
        <h5 className="text-lg min-[515px]:text-xl leading-normal font-normal text-center text-white-0">
        ...
        <button className="px-[0.875rem] py-2 rounded-[0.188rem] bg-red-500 text-base leading-[1.7rem] font-semibold text-white-0 hover:bg-red-600 hover:text-white-90">
          <a href="mailto:vinicius.buss13@gmail.com">Fale Comigo</a>
        </button>
